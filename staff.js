...
document.getElementById("marksSection").classList.toggle("hidden");
}

function calculateIAT(s){
...
row.insertCell(4).innerText = calculateIAT(u)+"%";
...
reports[i].reply="Your report reviewed. Changes soon";
